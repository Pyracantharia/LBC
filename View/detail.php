                                ...
                                <div class="card-body">
                                    <div class='card rounded hover-shadow'>
                                        <div class="card text-black">
                                            <h2><?= $titre ?><p class="float-end h3 text-black">Prix : <?= number_format($prix, 0, ',', ' ')  ?> €</p>
                                            </h2>
                                            <ul class="product-variation ">
                                                <h4 class="text-black">Description de l'annonce :</h4>
                                                <?php if ($categorie == 1) : ?>
                                                    <a class="badge badge-pill text-black" href="categorie.php?idcategorie=<?= $categorie ?>">Chaussure<i class="fa-solid fa-shoe-prints"></i></a>
                                                <?php elseif ($categorie == 2) : ?>
                                                    <a class="badge badge-pill text-black">Protection<i class="fa-solid fa-shield"></i></a>
                                                <?php elseif ($categorie == 3) : ?>
                                                    <a class="badge badge-pill text-black">Accessoires<i class="fa-regular fa-futbol"></i></a>
                                                <?php elseif ($categorie == 4) : ?>
                                                    <a class="badge badge-pill text-black">Couvre-Chef<i class="fa-solid fa-hat-cowboy"></i></a>
                                                <?php else : ?>
                                                    <a class="badge badge-pill text-black">Vetements<i class="fa-solid fa-shirt"></i></a>
                                                <?php endif; ?>
                                                <!-- selon la catégorie, un different badge va s'afficher  -->


                                                <span class="badge badge-pill text-black"><?= $nomMarque ?> <i class="fa-solid fa-book"></i></span>

                                                <span class="badge badge-pill text-black"><?= $etat ?> &nbsp<i class="fa-solid fa-thumbs-up"></i></span>
                                                ...
                                                <?php if ($livraison == 1) : ?>
                                                    <span class="badge badge-pill text-black">Livraison &nbsp<i class="fa-solid fa-truck"></i></span>
                                                <?php else : ?>
                                                    <span class="badge badge-pill text-black">Main propre &nbsp<i class="fa-solid fa-handshake"></i></span>
                                                <?php endif; ?>
                                                <!--  si l'annonce est en livraison alors affichage d'un badge sinon different badge pour en main propre -->

                                            </ul>
                                            <p><?= $detail ?></p>
                                            <p><span class="badge badge-gradient-dark text-bg-secondary"><i class="fa-solid fa-eye text-black"></i> <?= $vue ?></span></p>
                                            <p class="card-text"><small class="text-muted float-start"><p>Vendeur :</p><?= $nom ?> <?= $prenom ?></small><small class="text-muted"><br><p>Ville :</p><?= $nomVille ?><br><p>Date création annonce :</p><?= $date ?></small></p>
                                            <p>
                                                <?php if (isset($uid)) : ?>
                                                    <?php
                                                    ...
                                                    <?php } else {
                                                        $idc = $verif->fetch();
                                                    ?>
                                                        <a href="message.php?idc=<?= $idc["idc"] ?>" class="btn btn-secondary">Contacter le vendeur</a>
                                                    <?php } ?>
                                                <?php else : ?>
                                                    <a href="connexion.php" class="btn btn-secondary">Contacter le vendeur</a>
                                                <?php endif; ?>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <h5 class="modal-title text-black" id="ModalLabel">Nouveau message</h5>
